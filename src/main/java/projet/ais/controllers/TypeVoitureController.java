...
public class TypeVoitureController {
   ...
   @GetMapping("/getAllTypeVoituresWithPagination")
    public ResponseEntity<Page<TypeVoiture>> getTypeVoitures(@RequestParam() int page,
                                                  @RequestParam() int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<TypeVoiture> typeVoitures = typeVoitureService.getAllTypeVoiturePageable(pageable);
        return ResponseEntity.ok().body(typeVoitures);
    }
