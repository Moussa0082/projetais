...
public class CampagneController {
    ...
    @GetMapping("/getAllCampagneWithPagination")
    public ResponseEntity<Page<Campagne>> getCampagnes(@RequestParam() int page,
                                                  @RequestParam() int size) {
        Pageable pageable = PageRequest.of(page, size);
        Page<Campagne> campagnes = campagneService.getAllCampagnePageable(pageable);
        return ResponseEntity.ok().body(campagnes);
    }
