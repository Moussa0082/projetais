...
public class ParametreGenerauxService {
    ...
    //     public ResponseEntity<String> createParametreGeneral(ParametreGeneraux parametreGeneraux) {
        
    //         ParametreGeneraux existantParamatreGeneraux = parametreGenerauxRepository.findByNomContinent(continent.getNomContinent());
